  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16">
      ...
      <div className="grid md:grid-cols-3 gap-8 mb-16">
        <div className="border border-[var(--border)] rounded-lg p-6 hover:border-[var(--muted)] transition-colors">
      ...
      <div className="border-t border-[var(--border)] pt-8">
        ...
        <p className="text-[var(--muted)]">
          I typically respond to emails within 24-48 hours. For urgent matters, feel free to reach
          out via LinkedIn.
        </p>
      </div>
    </div>
